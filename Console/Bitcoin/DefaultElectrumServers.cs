namespace Console.Bitcoin
{
    ...
    {
        private static readonly Dictionary<string, string> DefaultPorts = new Dictionary<string, string>
    {
        {"s", "50002"},
        {"t", "50001"}
        ...
        public static readonly Dictionary<string, Dictionary<string, string>> DefaultServers = new Dictionary<string, Dictionary<string, string>>
    {            
